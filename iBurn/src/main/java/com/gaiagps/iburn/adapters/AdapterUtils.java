...
public class AdapterUtils {
    ...
    public static final Date EVENT_START_DATE = new GregorianCalendar(2018, Calendar.AUGUST, 26, 0, 0).getTime();
    public static final Date EVENT_END_DATE = new GregorianCalendar(2018, Calendar.SEPTEMBER, 4, 0, 0).getTime();
