...
//        val px = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24f, resources.displayMetrics).toInt()
    ...
    private fun setupMap(mapView: MapView) {
        mapView?.getMapAsync { map ->
            ...
            style.withImage("ESD Station 3", AppCompatResources.getDrawable(context, R.drawable.first_aid)!!)
            style.withImage("ESD Station 6", AppCompatResources.getDrawable(context, R.drawable.first_aid)!!)
            style.withImage("ESD Station 9", AppCompatResources.getDrawable(context, R.drawable.first_aid)!!)
            ...
            style.withImage("Arctica Outpost", AppCompatResources.getDrawable(context, R.drawable.ice)!!)
            ...
            style.withImage("Recycle Camp", AppCompatResources.getDrawable(context, R.drawable.recycle)!!)
            style.withImage("toilet", AppCompatResources.getDrawable(context, R.drawable.toilet)!!)
            style.withImage("Artery", AppCompatResources.getDrawable(context, R.drawable.artery)!!)
            style.withImage("Yellow Bike Project", AppCompatResources.getDrawable(context, R.drawable.bike)!!)
            style.withImage("Hell Station", AppCompatResources.getDrawable(context, R.drawable.fuel)!!)
            style.withImage("Census Checkpoint", AppCompatResources.getDrawable(context, R.drawable.census)!!)
            style.withImage("BLM LE Substation", AppCompatResources.getDrawable(context, R.drawable.police)!!)
            style.withImage("Gate Actual", AppCompatResources.getDrawable(context, R.drawable.gate)!!)
            style.withImage("Box Office", AppCompatResources.getDrawable(context, R.drawable.box_office)!!)
            style.withImage("Greeters", AppCompatResources.getDrawable(context, R.drawable.greeters)!!)
    ...
    private fun showEditPinDialog(marker: MapMarker) {
        ...
        userPoi?.let { userPoi ->
            ...
            dialogBody.findViewById<View>(R.id.sharePin).setOnClickListener {
                try {
            ...
            val builder = AlertDialog.Builder(requireActivity(), R.style.Theme_Iburn_Dialog)
                .setView(dialogBody)
                // AlertDialog lays these out neutral, negative, positive from left to right.
                .setNeutralButton(R.string.delete) { _, _ ->
                    removeCustomPin(marker)
                }
                .setNegativeButton(R.string.move) { _, _ ->
                    saveEdits()
                    if (state != State.PLACE_USER_POI) {
                        val prePlaceUserPoiState = state
